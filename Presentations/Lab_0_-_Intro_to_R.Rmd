...
These training sessions will offer a quick introduction to R, its amazing features and why it is so much better than Stata (and Excel). 
 ...
 * __Exporting summary statistics and regression tables__
 * __Creating awesome-looking plots__
 * __Writing reproducible and readable code__
 * __Creating awesome-looking maps__
 * __Cleaning data__
...
### Before we start, type in your console and press enter:
```{r, eval= F}
 ...
 * Whenever you click something in your computer, you are giving it instructions to do something.
 * Code is a way to give instructions, by writing text in a specific language.
 * Key differences:
 ...
 * Reproducibility:
    + When you add new lines to your data, you don't have to change your analysis.
    + You can re-use your code (or anyone elses) with small changes with entirely different data.
 * Transparency:
    + You see every step of the analysis.
 * Speed and flexiblity.
 * R is more forgiving with errors:
    + When you open a sheet in R, you create a virtual copy. So you never change the original file.  
...
### Script:
Where you write your instructions if you want to send multiple instructions at once.
...
Objects are the building blocks of R programming. T his section will explore some of the most common.
...
\framesubtitle{Coding workflow}
 ...
 1. Pick problem
 2. Think of how to solve the problem
 3. Write code little by little:
...
There are two different ways use code:
 ...
 1. Give instructions for the computer to give you some information, these we usually type directly in the console.
 
 2. The instructions for the computer to perform the actual tasks need for your analysis. These are the ones you want in your script.


## First R code

### Exercise 6
Write code to produce a line graph containing the happiness index over the years for Rwanda and it's neighbors.
...
whrRwaBorC$year  <- as.integer(whrRwaBorC$year)
...
1. Clean your memmory by typing `rm(list = rm())` and pressing enter.
2. Open template script called Lab 0 - First R code.R 
3. Follow the instructions in the script.

## First R code

### Exercise 6 - Update your data!
1. Now, chage the data by replacing the name of the file in the code with whr_panel_18.csv
2. Re run your code without changing anything else.
